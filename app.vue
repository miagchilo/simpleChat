<template>
  ...
  <div class="isolate bg-white">
    ...
    <div>
      <div
        class="flex justify-center flex h-screen bg-[url('https://media1.giphy.com/media/A06UFEx8jxEwU/200.webp?cid=ecf05e47sg3syymjog9404sb0juuzn2sfxrgturolmmg0qm0&rid=200.webp&ct=g')]"
        v-if="!connected"
      >
      ...
      <div v-if="connected">
        <h1 class="flex justify-center">FLOOD</h1>
        <div class="flex justify-center">
          <div class="flex flex-row gap-4">
            ...
            <input
              v-model="text"
              @keyup.enter="send"
              @focus="startTyping(nickname)"
              @blur="stopTyping(nickname)"
              class="bg-[url('https://media1.giphy.com/media/A06UFEx8jxEwU/200.webp?cid=ecf05e47sg3syymjog9404sb0juuzn2sfxrgturolmmg0qm0&rid=200.webp&ct=g')] border border-gray-100 text-yellow-300"
              v-if="connected"
            />
